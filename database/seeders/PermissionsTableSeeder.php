...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //permission for penguruses
        Permission::create(['name' => 'penguruses.index']);
        Permission::create(['name' => 'penguruses.create']);
        Permission::create(['name' => 'penguruses.edit']);
        Permission::create(['name' => 'penguruses.delete']);
